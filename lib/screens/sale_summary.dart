...
class _SaleSummaryState extends State<SaleSummary> {
  ...
  SaleSummaryResponse? _summaryData;
  ...
  Future<void> _loadSummary() async {
    ...
    try {
      final data = await ApiService.getItemsSaleSummary(
      ...
      log('Error loading sale summary: $e');
    }
  }
  ...
  Widget _buildContent() {
    if (_selectedStation == null) {
      return _emptyState(
        icon: Icons.warehouse,
        title: 'Select a station to view sale summary',
    ...
    if (_summaryData == null || _summaryData!.isEmpty) {
      return _emptyState(
        ...
        subtitle: 'No delivered sales for the selected date and station.',
      );
    }
  ...
  Widget _buildItemCard(SaleSummaryItem item) {
    return Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                // if (item.pickupPoint.isNotEmpty) ...[
